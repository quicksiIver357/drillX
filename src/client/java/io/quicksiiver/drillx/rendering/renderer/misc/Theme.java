...
public class Theme {
    ...
    public Color fieldSelectedSquad; // color of the selected squad on the field
    ...
    public static final Theme DEFAULT = new Theme(Color.WHITE, new Color(94, 169, 79), Color.WHITE, Color.BLACK, Color.RED, Color.YELLOW, Color.WHITE, Color.BLUE, new Font("TimesRoman", Font.PLAIN, 10)); // preset

    public Theme(Color drill, Color field, Color fieldLine, Color fieldNumber, Color fieldSquad, Color fieldSelectedSquad, Color squad, Color fieldArrow, Font font) {
        this.drill = drill;
        this.field = field;
        this.fieldLine = fieldLine;
        this.fieldNumber = fieldNumber;
        this.fieldSquad = fieldSquad;
        this.fieldSelectedSquad = fieldSelectedSquad;
        this.squad = squad;
